...
function get20s(array) {
  for (let i=0; i<array; i++){
    if( newArray <=1959 && newArray <=1925);
  }
 return newArray.split
}
console.log(newArray(artists));
...
function addArtist(array) {
  return array.push('id: 20, name: Jessica Prosper, years: 1987 - 16, genre: Web Design, nationality: Haitian American, bio: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.');
}
